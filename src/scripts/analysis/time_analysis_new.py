...
def run(model_name: str, speeches_all_preproc: str, outdir: str, topic_threshold: int) -> None:
...
if __name__ == '__main__':
  ...
  speeches_all_preproc     = "data/speeches_all_preproc_filtered.pickle"
  outdir                   = "results/time_topics_{}".format(model_name)
  topic_threshold          = 1 # top 1 topics

  if os.path.exists(outdir):
    shutil.rmtree(outdir)
  os.makedirs(outdir)

  run(model_name, speeches_all_preproc, outdir, topic_threshold)
